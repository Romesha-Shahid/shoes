export default function ContactInfo(){
    return(
        <div className="p-4">
        <h2 className="text-[16px] font-medium text-center mt-4 mb-4">Whats your contact information?</h2>
...
{/* PAN Section */}
<h2 className="text-[18px] font-medium text-center mt-6 mb-4">Whats your PAN?</h2>
